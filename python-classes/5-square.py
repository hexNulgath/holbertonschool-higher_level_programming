...
class Square:
    ...
    def my_print(self):
        ...
        The print is offset by the square's position attribute.
        If the size is 0, a blank line is printed. The number of lines
        is equal to the size, and each line is indented by the
        position's first element.
